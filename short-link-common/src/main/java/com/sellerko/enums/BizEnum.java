...
public enum BizEnum {
    ...
    public static BizEnum getInstance(int code) {
        return Arrays.stream(BizEnum.values()).filter(it -> it.getCode() == code).findFirst().orElse(null);
    }
